        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <div>
            ...
            <select
              ...
              value={formData.role}
              onChange={handleChange}
              className="w-full rounded-lg bg-white/10 border border-white/20 px-4 py-2.5 text-white outline-none focus:ring-2 focus:ring-white/40"
            >
              <option value="student" className="text-gray-300 bg-black/70">Student</option>
              <option value="admin" className="text-gray-300 bg-black/70">Admin</option>
            </select>
          </div>
